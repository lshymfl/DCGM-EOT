...
class Encoder(nn.Module):  
    def __init__(self, dim_z=1200, dim_f=80):
        super(Encoder, self).__init__()
        self.init_conv = nn.Conv2d(3, dim_f, 3, 2, 1) 
...
class Decoder(nn.Module):
    def __init__(self, dim_z=1200, dim_f=80):
        ...
        self.out_conv = nn.Sequential(nn.ConvTranspose2d(dim_f, 3, 2, 2, 0), nn.Tanh(), )
...
class autoencoder(nn.Module):
    ...
    def __init__(self, dim_z=None, dim_f=None):
