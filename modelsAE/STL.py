...
class Encoder(nn.Module):  
    def __init__(self, dim_z=256, dim_c=3, dim_f=64):
        ...
        self.conv2 = nn.Conv2d(16*dim_f, dim_z, 3, 1, 0) # 100 1 1 
...
class Decoder(nn.Module):
    def __init__(self, dim_z=256, dim_c=3, dim_f=64):
        ...
        self.convT1 = nn.ConvTranspose2d(dim_z, 16*dim_f, 3, 1, 0) #  1,1 -->4,4 
        ...
        self.convT2 = nn.Sequential(nn.ConvTranspose2d(dim_f, 3, 2, 2, 0),nn.LeakyReLU(0.2, inplace=True),)
