...
def get_args():
    ...
    parser.add_argument('--resolution', type=int, default=64,help='original images size') ##32/64
    ...
    parser.add_argument('--maxItersdot', type=int, default=2000,help='max iters of train ot')
    parser.add_argument('--lr_ot', type=int, default=5e-1,help='learning rate of calculate the update step based on gradient')
    ...
    parser.add_argument('--N', type=int, default=60,help='cyclic generation of random measures to obtain the height vector and measure')
    ...
    parser.add_argument('--netbatch_size', type=int, default=512, help=' batch size of AE training')## 4096/2e-4/0.9
    parser.add_argument('--feature_dim', type=int, default=1024, help=' dimension of feature')
    parser.add_argument('--measure_dim', type=int, default=1, help=' dimension of measure embedding')
    parser.add_argument('--lr_net', type=float, default=3e-3, help='learning rate of AE training')##  
    ...
    parser.add_argument('--hmodel', type=str, default='./CelebA_new/h_models/Epoch_179_models.pth', help='root path to h models')
    ...
    parser.add_argument('--alter_measture', default=False, type=str2bool, help='achieving h via alter measure')
    parser.add_argument('--alter_measture_nums', default=186232, type=float, help='achieving h via alter measure')
    ...
    #------ generated images -------------
    parser.add_argument('--gen_nums', type=int, default=100,help='max number of generated samples')##
    ...
    parser.add_argument('--Lambda', type=int, default=1.0, help='the nearest k samples around current sample')
    parser.add_argument('--label', type=int, default=1, help='Data categories contained in the raw data')
    
    #######################################FID and IS
    parser.add_argument('--result_root_path', type=str, default='./CelebA_new/', help='root path to save results')
...
if __name__ == "__main__":
    ...
    for action in actions:
        ...
        fileName = './CelebA_new/celeba_labels.csv'
